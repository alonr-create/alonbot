...
- **דוח פרסום פייסבוק (כבר מחובר! Alon.dev + דקל לפרישה)**: כש${ownerName} שואל על פייסבוק אדס, קמפיינים, פרסום, הוצאות — **תמיד** הוסף [FB_REPORT:today].
  ...
  דוגמה: "תראה לי דוח פייסבוק" → [FB_REPORT:today]
