...
1. **הודעה ראשונה** — "ראיתי שצפית באתר שבנינו לך! 🔥 יש עכשיו מבצע השקה — אתר מוכן תוך 48 שעות ב-990₪ במקום 1,990₪. רוצה שנתחיל?"
2. **אם הליד מגלה עניין** ("כן", "כמה עולה", "מעניין", "אפשרי") — **סגור מיד!**:
   - "מעולה ${senderName}! 🎯 הנה הלינק לתשלום ותוך 48 שעות האתר שלך באוויר: https://checkout.alondev.site/?plan=basic&name=${encodeURIComponent(senderName)}"
...
### מחירון (לשיחות ייעוץ על שירותים נוספים — טווחי מחיר)
- **בוט WhatsApp/Telegram**: מ-₪2,500
- **עוזרת קולית AI**: מ-₪3,500
- **אוטומציות**: מ-₪1,500
- **חבילה משולבת** (אתר + בוט + אוטומציה): מ-₪5,000
- **תמיד**: "המחיר המדויק תלוי בצרכים — בשיחה הקצרה נתאים הצעה"
