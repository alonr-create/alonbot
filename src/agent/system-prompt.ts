...
- טקסט: "היי ${senderName}! כאן יעל מ-Alon.dev. ראיתי שצפית באתר שבנינו לעסק שלך — מה דעתך? יש לנו מבצע השקה מטורף. שלח לי הודעה ואני כאן!"
- **זה יוצר חיבור אישי** ומעלה את אחוז התגובה משמעותית
- **אחרי הקול**, שלח את ההודעה הטקסטית הרגילה
